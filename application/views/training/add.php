...
$(function(){
    $('.add_study').click(function(){
        ...
        '<td><label>تاریخ شروع<span class="error">*</span></label><?php echo $f->select('d_start[]',array('decoration'=>FALSE,'type'=>'select','options'=>'days_of_month')); echo $f->select('m_start[]',array('decoration'=>FALSE,'type'=>'select','options'=>'months_of_year')); echo $f->select('y_start[]',array('decoration'=>FALSE,'type'=>'select','options'=>Utility::years(30,-1))); ?></td>'+
        '<td><label>تاریخ پایان<span class="error">*</span></label><?php echo $f->select('d_end[]',array('decoration'=>FALSE,'type'=>'select','options'=>'days_of_month')); echo $f->select('m_end[]',array('decoration'=>FALSE,'type'=>'select','options'=>'months_of_year'));echo $f->select('y_end[]',array('decoration'=>FALSE,'type'=>'select','options'=>Utility::years(30,-1))); ?></td></tr><tr><td><?php echo $f->makeField('period[]', array('type'=>'text','in'=>'class="txt" maxlength="10"','label'=>'مدت دوره<span class="error">*</span>','out'=>' ساعت'));?></td><td><?php echo $f->makeField('grade[]', array('type'=>'text','in'=>'class="txt" maxlength="10"','label'=>'نمره اخذ شده<span class="error">*</span>'));?></td><td><?php echo $f->makeField('point[]', array('type'=>'text','in'=>'class="txt" maxlength="10"','label'=>'امتیاز دوره<span class="error">*</span>'));?></td>'+
