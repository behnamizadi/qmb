...
<input type="hidden" name="c_path" value="<? echo isset($_POST['c_path']) ? $_POST['c_path'] : 2; ?>"  id="c_path" />
<h4>وضعیت فعلی</h4>
<table class="create">
    <tr>
        <td>
            <?php
            echo $f->select('employment_status1', array(
                'options'=>$employment_status,
                'label'=>'وضعیت استخدام<span class="error">*</span>'
                ));
            ?>
        </td>
        <td>
            <?php
            echo $f->select('job_status1', array(
                'options'=>$job_status,
                'label'=>'وضعیت اشتغال<span class="error">*</span>'
                ));
            ?>
        </td>
         <td>
            <?php
            echo $f->select('hokm_type1', array(
                'options'=>$hokm_type,
                'label'=>'نوع حکم<span class="error">*</span>'
                ));
            ?>
        </td>
    </tr><tr>
        <td>
           ...
           <?php
           echo $f->select('d_start1',array(
                    'decoration'=>FALSE,
                    'type'=>'select',
                    'options'=>
                    'days_of_month'
                )); 
           echo $f->select('m_start1',array(
                    'decoration'=>FALSE,
                    'type'=>'select',
        ...
        <td>
            <?php
            echo $f->select('post1', array(
                'options'=>$post,
                'label'=>'پست سازمانی<span class="error">*</span>'
                ));
            ?>
        </td>
        <td>
            <?php
            echo $f->select('degree1', array(
                'options'=>$post2,
                'label'=>'درجه'
                ));
            ?>
        ...
        <td>
            <?php
            echo $f->makeField('emtiaz_shoghl1', array(
                'type'=>'text',
                'label'=>'امتیاز شغل',
                'in'=>'class="txt" maxlength="30"'
            ));
            ?>
            </td>
        <td>
            <?php
            echo $f->radio('place1', array(
                'value'=>array(
                        1=>'سرپرستی',
                        2=>'شعبه'
                    ),
                 'label'=>'محل خدمت<span class="error">*</span>',
                 'in'=>array(1=>'class="fadeout1"',2=>'class="fadein1"'),
        ...
        <td>
            ...
            echo $bDisp;
            echo $f->select('branches1', array(
                'options'=>$branches,
                'label'=>'شعبه<span class="error">*</span>'
                ));
            ?>
            </div>
        </td>
...
for($i = 2; $i <= 10;$i++):
    ...
    if($flag === TRUE && $set === FALSE)
        echo '<table class="create" style="margin-bottom: 5px;display: none;" id="cpathadd'.$i.'">';
    elseif($flag === FALSE || ($flag === TRUE && $set === TRUE))
        echo '<table class="create" style="margin-bottom: 5px;" id="cpathadd'.$i.'">';
?>
    <tr>
        <td>
            <?php
            echo $f->select('employment_status'.$i, array(
                'options'=>$employment_status,
                'label'=>'وضعیت استخدام<span class="error">*</span>'
                ));
            ?>
        ...
        <td>
            <?php
            echo $f->select('job_status'.$i, array(
                'options'=>$job_status,
                'label'=>'وضعیت اشتغال<span class="error">*</span>'
                ));
            ?>
         ...
         <td>
            <?php
            echo $f->select('hokm_type'.$i, array(
                'options'=>$hokm_type,
                'label'=>'نوع حکم<span class="error">*</span>'
                ));
            ?>
        ...
        <td>
            <?php
            echo $f->makeField('emtiaz_shoghl'.$i, array(
                'type'=>'text',
                'label'=>'امتیاز شغل<span class="error">*</span>',
                'in'=>'class="txt" maxlength="30"'
            ));
            ?>
         </td>
            <td>
            <?php
            echo $f->radio('place'.$i, array(
                'value'=>array(
                        1=>'سرپرستی',
                        2=>'شعبه'
                    ),
                 'label'=>'محل خدمت<span class="error">*</span>',
                 'in'=>array(1=>'class="fadeout'.$i.'"',2=>'class="fadein'.$i.'"'),
                 'showFieldErrorText'=>TRUE
                ));
            ?>
        </td>
        ...
        <td>
            ...
            echo $bDisp;
            echo $f->select('branches'.$i, array(
                'options'=>$branches,
                'label'=>'شعبه<span class="error">*</span>'
                ));
            ?>
...
?>
<img src="<?php echo PHP40::get()->homeUrl; ?>public/images/plus.png" style="cursor:pointer" alt="افزودن مسیر شغلی"  class="add_c_path" />
