<div id="menu">
	<ul id="css3menu1" class="topmenu">
		<li class="topfirst">
			...
			<ul>
				<li>
					<a href="<?php echo $path; ?>index.php/user/change_pass">تغییر رمز عبور</a>
				</li>

			</ul>
		</li>
		<li class="topmenu">
			<a href="#"><span>اطلاعات پایه</span></a>
			<ul>
				<li>
					<a href="#"><span>اطلاعات شغلی »</span></a>
					<ul>
						<li>
				...
				<li>
					<a href="#"><span>اطلاعات فردی »</span></a>
					<ul>
						<li>
		...
		<li class="topmenu">
			...
			<ul>
				...
				<li>
					<a href="#"><span>ویرایش شعبه»</span></a>
					<ul>
						<li>
		...
		<li class="topmenu">
			<a href="#" ><span>مدیریت کارمندان</span></a>
			<ul>
				<li>
		...
		<li class="topmenu">
			<a href="#" ><span>تشویقات و تنبیهات</span></a>
			<ul>
				<li>
		...
		<li class="topmenu">
			<a href="#" ><span>دوره‌های آموزشی</span></a>
			<ul>
				<li>
		...
		<li class="topmenu">
			<a href="#" ><span>نمرات ارزشیابی</span></a>
			<ul>
				<li>
		...
		<li class="topmenu">
			<a href="#" ><span>اخطار تمدید</span></a>
			<ul>
				<li>
					<a href="#">باجه عصر »</a>
					<ul>
		...
		<li class="topmenu">
			...
			<ul>
				...
				<li>
					<a href="<?php echo $path; ?>index.php/report/r3">اطلاعات تحصیلی کارمندان</a>
				</li>
			</ul>
		</li>
		<li class="topmenu">
			<a href="#" ><span>درباره «یاغیش»</span></a>
			<ul>
				<li>
		...
		<li class="toplast">
			<a href="<?php echo $path; ?>index.php/user/logout" >خروج</a>
		</li>
	</ul>
</div>