...
$c['default'] = 'انتخاب';
return array('index' => array('takafol' => array('type' => 'text', 'in' => 'class="txt" maxLength="2"', 'validation' => 'maxLength[2],required,number', 'label' => 'تعداد افراد تحت تکفل', ), 'submit' => array('type' => 'submit', 'value' => 'مرحله بعد', 'in' => 'class="btn btn-primary"'), ), 
'add' => array('<h3>اطلاعات همسر</h3>',
    'name' => array('type' => 'text',  'validation' => array('required,maxLength[30]'), ), 
 'lastname' => array('type' => 'text', 'in' => 'class="txt" maxlength="50"', 'validation' => array('required,maxLength[50]'), ), 
 'sh_sh' => array('type' => 'text', 'in' => 'class="txt" maxlength="10"', 'validation' => array('required,maxLength[10],number'), ), 
 'code_melli' => array('type' => 'text', 'in' => 'class="txt" maxlength="10"', 'validation' => array('required,length[10],number'), ), 
 'father' => array('type' => 'text', 'in' => 'class="txt" maxlength="30"', 'validation' => array('required,maxLength[30]'), ), 
...
'y_born' => array('decoration' => FALSE, 'type' => 'select', 'options' => Utility::years(70,-10), 'validation' => array('required'), ),
 'city_born' => array('type' => 'text', 'in' => 'class="txt" maxlength="30"', 'validation' => array('required,maxLength[30]'), ), 
 '<label>تاریخ ازدواج<span class="error">*</span></label>', 
 'd_married' => array('decoration' => FALSE, 'type' => 'select', 'options' => 'days_of_month', 'validation' => array('required'), ), 
 'm_married' => array('decoration' => FALSE, 'type' => 'select', 'options' => 'months_of_year', 'validation' => array('required'), ), 
 'y_married' => array('decoration' => FALSE, 'type' => 'select', 'options' =>  Utility::years(70,0), 'validation' => array('required'), ), 
 ...
 'job' => array('type' => 'text', 'validation' => array('required,maxLength[128]'), ), ), 
