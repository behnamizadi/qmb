...
if (Indx==2){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
options[1]=new Option("آواجیق","1");
options[2]=new Option("اروميه","2");
options[3]=new Option("اشنويه","3");
options[4]=new Option("ایواوغلی","4");
options[5]=new Option("باروق","5");
options[6]=new Option("بازرگان","63");
options[7]=new Option("بوكان","7");
options[8]=new Option("پلدشت","8");
options[9]=new Option("پيرانشهر","9");
options[10]=new Option("تازه‌شهر","10");
options[11]=new Option("تكاب","11");
options[12]=new Option("چالدران","12");
options[13]=new Option("چایپاره","13");
options[14]=new Option("چهاربرج","14");
options[15]=new Option("خلیفان","15");
options[16]=new Option("خوي","16");
options[17]=new Option("ربط","17");
options[18]=new Option("سردشت","18");
options[19]=new Option("سرو","19");
options[20]=new Option("سلماس","20");
options[21]=new Option("سیلوانه","21");
options[22]=new Option("سیمینه","22");
options[23]=new Option("سيه چشمه","23");
options[24]=new Option("شوط","24");
options[25]=new Option("شاهين دژ","25");
options[26]=new Option("فیرورق","26");
options[27]=new Option("قره‌ضیاءالدین","27");
options[28]=new Option("قطور","28");
options[29]=new Option("قوشچی","29");
options[30]=new Option("کشاورز","30");
options[31]=new Option("گردکشانه","31");
options[32]=new Option("ماكو","32");
options[33]=new Option("محمدیار","33");
options[34]=new Option("محمودآباد","34");
options[35]=new Option("مرگنلر","35");
options[36]=new Option("مهاباد","36");
options[37]=new Option("مياندوآب","37");
options[38]=new Option("میرآباد","38");
options[39]=new Option("نازک علیا","39");
options[40]=new Option("نالوس","40");
options[41]=new Option("نقده","41");
options[42]=new Option("نوشین‌شهر","42");
}
if (Indx==3){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
...
if (Indx==5){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
options[1]=new Option("ساوجبلاق","1");
options[2]=new Option("طالقان","2");
options[3]=new Option("کرج","3");
options[4]=new Option("نظرآباد","4");
options[5]=new Option("اشتهارد","5");
}
if (Indx==6){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
...
options[2]=new Option("اسلامشهر","2");
options[3]=new Option("اشتهارد","3");
options[4]=new Option("بومهن","4");
options[5]=new Option("پاكدشت","5");
options[6]=new Option("تجريش","6");
options[7]=new Option("تهران","7");
options[8]=new Option("چهاردانگه","8");
options[9]=new Option("دماوند","9");
options[10]=new Option("رباط كريم","10");
options[11]=new Option("رودهن","11");
options[12]=new Option("ري","12");
options[13]=new Option("شريف آباد","13");
options[14]=new Option("شهريار","14");
options[15]=new Option("طالقان","15");
options[16]=new Option("فشم","16");
options[17]=new Option("فيروزكوه","17");
options[18]=new Option("قدس","18");
options[19]=new Option("قرچك","19");
options[20]=new Option("كن","20");
options[21]=new Option("كهريزك","21");
options[22]=new Option("گلستان","22");
options[23]=new Option("لواسان","23");
options[24]=new Option("ملارد","24");
options[25]=new Option("ورامين","25");
options[26]=new Option("هشتگرد","26");
}
if (Indx==9){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
...
options[12]=new Option("1نيكشهر","2");
}
if (Indx==17){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
...
options[8]=new Option("جهرم","8");
options[9]=new Option("حاجي آباد","9");
options[10]=new Option("خرم بید","10");
options[11]=new Option("خنج","11");
options[12]=new Option("خشت","12");
options[13]=new Option("داراب","13");
options[14]=new Option("شيراز","14");
options[15]=new Option("فراشبند","15");
options[16]=new Option("فسا","16");
options[17]=new Option("فيروز آباد","17");
options[18]=new Option("قيرو کارزین","18");
options[19]=new Option("كازرون","19");
options[20]=new Option("لار","20");
options[21]=new Option("لامرد","21");
options[22]=new Option("مرودشت","22");
options[23]=new Option("نورآباد","23");
options[24]=new Option("ني ريز","24");
}
if (Indx==18){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
...
options[6]=new Option("مس سرچشمه","6");
...
options[13]=new Option("مينو دشت","13");
}
if (Indx==25){
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
